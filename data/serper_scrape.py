...
plant_names = [ "brocoli", "cabbage", "cauliflower", "Chamomile", "Cherry", "chilli pepper",
               "Coconut", "Coffe Beans", "Coriander", "carrot", "Cotton", "cucumber", "Date Palm",
               "Garlic", "Ginger", "Grapes", "Green gram (Mung bean)", "Groundnut(Peanut)", "Guava",
               "Jute"
]
